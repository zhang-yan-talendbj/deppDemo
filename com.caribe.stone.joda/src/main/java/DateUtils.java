...
public class DateUtils {
    public static final DateFormat DEFAULT_TIMESTAMP_FORMAT = new SimpleDateFormat("dd-MM-yyyy HH:mm:ss (SSS) z");
    public static final DateFormat DEFAULT_REPORT_TIMESTAMP_FORMAT = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss (SSS)");
    public static final DateFormat DEFAULT_DATE_FORMAT = new SimpleDateFormat("d/M/yyyy");
...
//    }
     ...
     * @param pattern date format of date.
     * @return the date represented by the argument in Date.
     * @throws IllegalArgumentException If the value is not parsable
     */
//    public static Date parseStringForDate(String value, String pattern) throws IllegalArgumentException {
...
//    }
     ...
     * 
     * @param target
     * @param left (null = -INF) (ie. don't check that left &lt;= target)
     * @param right (null = +INF) (ie. don't check that target &lt;= right)
     ...
     * @throws IllegalArgumentException If date1 or date2 is null
     * @throws IllegalArgumentException If date1 is after date2
     */
     ...
     * current date.
     * 
     * @param current the date that is after the current financial year
