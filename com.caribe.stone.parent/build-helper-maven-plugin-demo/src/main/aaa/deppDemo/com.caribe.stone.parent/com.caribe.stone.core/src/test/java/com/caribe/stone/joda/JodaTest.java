...
public class JodaTest {
	...
	public void testName() throws Exception {
		assertEquals(-1,
				new Period(new DateTime(DateUtils.parse("2012/12/12")), new DateTime(DateUtils.parse("2011/12/11")), PeriodType.years())
						.getYears());
		assertEquals(1,
				new Period(new DateTime(DateUtils.parse("2011/12/12")), new DateTime(DateUtils.parse("2012/12/12")), PeriodType.years())
						.getYears());
		// assertEquals(
		// -366,
		// new Period(new DateTime(DateUtils.parse("2012/12/11")), new
		// DateTime(DateUtils
...
//		assertEquals("/25-Dec", dateTime.toString("/dd-MMM"));
	...
	public void betwenMonth() throws Exception {
		...
		assertTrue(isAcross(DateUtils.parse("2011/10/11", "yyyy/MM/dd"), DateUtils.parse("2012/10/11", "yyyy/MM/dd"), ""));
		assertTrue(isAcross(DateUtils.parse("2011/10/11", "yyyy/MM/dd"), DateUtils.parse("2014/10/11", "yyyy/MM/dd"), ""));
		assertFalse(isAcross(DateUtils.parse("2011/10/11", "yyyy/MM/dd"), DateUtils.parse("2012/10/1", "yyyy/MM/dd"), null));
		assertTrue(isAcross(DateUtils.parse("2011/10/12", "yyyy/MM/dd"), DateUtils.parse("2012/05/10", "yyyy/MM/dd"), "(10/5)"));
		assertTrue(isAcross(DateUtils.parse("2011/10/12", "yyyy/MM/dd"), DateUtils.parse("2012/05/10", "yyyy/MM/dd"), "(12/10)"));
		assertFalse(isAcross(DateUtils.parse("2011/10/12", "yyyy/MM/dd"), DateUtils.parse("2012/10/10", "yyyy/MM/dd"), "(11/10)"));
		assertFalse(isAcross(DateUtils.parse("2012/10/01", "yyyy/MM/dd"), DateUtils.parse("2012/10/10", "yyyy/MM/dd"), "(30/9)"));
	}
	...
	public boolean isAcross(Date from, Date to, String claimEscalationDateString) throws ParseException {
		...
		if (calendar.getTime().getTime() >= from.getTime() && calendar.getTime().getTime() <= to.getTime()) {
			return true;
		}
