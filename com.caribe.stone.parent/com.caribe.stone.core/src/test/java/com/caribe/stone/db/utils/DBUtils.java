...
public class DBUtils {
	...
	static {
		try {
			inputStream = new ClassPathResource("db2.properties").getInputStream();
		} catch (IOException e) {
...
//		openjpa.jdbc.Schema:jpa
		...
		Connection con = DriverManager.getConnection(p.getString(OPENJPA_CONNECTION_URL), p.getString(OPENJPA_CONNECTION_USER_NAME),
